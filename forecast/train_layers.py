...
for similarity_measure in ['MMD', 'CS']:

    config = {
        'model': 'Layer',
        'loss': 'LayerLoss',
        'lambda_OLS': [0, 0.01, 0.1, 1, 10],
        'lambda_sparse': [0, 0.01, 0.1, 1], # [0, 0.01, 0.1, 1, 10]
        # 'lambda_OLS': [1],
        # 'lambda_sparse': [1],
    ...
    folder_name = f"Layers_{args['Layer_hps']['feature_extractor']}_{ft_e2e}_{config['similarity_measure_name']}_{args.seed}_{gp_args.split_attribute}_{time.strftime('%Y%m%d-%H%M%S')}"
    ...
    # for lambda_ols, lambda_l1 in itertools.product(config['lambda_OLS'], config['lambda_sparse']):
    for lambda_ols, lambda_l1 in [(0, 10), (0.01, 10), (0.1, 10), (1, 10), (10, 10), (10, 0), (10, 0.01), (10, 0.1), (10, 1)]:
